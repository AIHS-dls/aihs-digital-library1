            ...
            if(isLibrarian()){
                ...
                adminButtons = `
                    ...
                    <div style="margin-top:15px;">
                        ...
                        <button
                            type="button"
                            onclick="editQuestionPaper('${resource.id}')"
                        >
                            ✏ Edit
                        </button>
                        ...
                        <button
                            type="button"
                            onclick="deleteQuestionPaper('${resource.id}')"
                            style="
                                background:#c62828;
                                color:white;
                            "
...
async function uploadQuestionPaper(){
    ...
    if(!isLibrarian()){
        ...
        alert(
            "Access Denied\n\nOnly Librarian can upload Question Papers."
        );
    ...
    if(!title){
        ...
        alert(
            "Please enter Question Paper Title."
        );
...
async function deleteQuestionPaper(id){
    ...
    if(!isLibrarian()){
        ...
        alert(
            "Access Denied\n\nOnly Librarian can delete Question Papers."
        );
...
function editQuestionPaper(id){
    ...
    if(!isLibrarian()){
        ...
        alert(
            "Access Denied\n\nOnly Librarian can edit Question Papers."
        );
